...
public class MethodInfo {
    ...
    /**
     * The number of parameters of the get function
     */
    ...
    /**
     * Gain function's parameter list, the list each element for the variable type
     */
    ...
    /**
     * Analytic function list file, it contains a list of all the source files in the folder, with "-- -- -- -- -- -" space
     * file:{filepath}
     * filename
     * Some({startLine})
     * Some({endLine})
    ...
    /**
     * Access to the file path and the function of the map
     */
