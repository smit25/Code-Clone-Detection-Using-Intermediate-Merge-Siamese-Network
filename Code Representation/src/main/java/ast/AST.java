...
public class AST {
    ...
    // Get the ast under the method from the ast json file
    ...
    // Generate the corresponding ast dot file for each method, and store at base/ast/{classFolder/sourceFile/methodName_signature/ast.dot}
